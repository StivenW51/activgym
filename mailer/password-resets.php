...
<head>
  ...
  <title>Restablece tu contraseña - ActivGym</title>
  <!-- Font Awesome CSS -->
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Recibes este correo porque has solicitado restablecer la contraseña de tu cuenta en ActivGym. Para continuar con el proceso, haz clic en el siguiente enlace:</p>
      <div class="cta">
      ...
      <p>Gracias,<br>El equipo de ActivGym</p>
    </div>
    <div class="footer">
